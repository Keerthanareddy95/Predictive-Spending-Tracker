...
class MSE(Evaluation):
    ...
    def calculate_scores(self, y_true: np.ndarray, y_pred: np.ndarray) :
        ...
        try:
            ...
            logging.error("Exception occurred in calculate_scores method of the MSE class. Exception message: {}".format(e))
            raise e
...
class R2(Evaluation):
    ...
    def calculate_scores(self, y_true: np.ndarray, y_pred: np.ndarray):
        ...
        try:
            ...
            logging.error("Exception occurred in calculate_scores method of the R2Score class. Exception message:  {}".format(e))
            raise e
...
class RMSE(Evaluation):
    ...
    def calculate_scores(self, y_true: np.ndarray, y_pred: np.ndarray):
        ...
        try:
            ...
            logging.error("Exception occurred in calculate_scores method of the RMSE class. Exception message:  {} ".format(e))
            raise e